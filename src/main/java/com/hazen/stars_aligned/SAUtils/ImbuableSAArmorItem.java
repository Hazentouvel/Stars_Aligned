...
public class ImbuableSAArmorItem extends SAArmorItem implements IPresetSpellContainer {
    public ImbuableSAArmorItem(Holder<ArmorMaterial> material, ArmorItem.Type type, Item.Properties properties, AttributeContainer... attributeContainers) {
